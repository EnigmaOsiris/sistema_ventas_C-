   ...
   public  class DArticulos
    {
        ...
        public DArticulos(int idarticulo, string codigo, string nombre, string descripcion, byte[] imagen, int idcategoria, int presentacion, string textobuscar)
        {
        ...
        public string Insertar(DArticulos Articulo)
        {
            string rpta = "";
        ...
        //Método Editar
        public string Editar(DArticulos Articulo)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
        ...
        //Método Eliminar
        public string Eliminar(DArticulos Articulo)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
